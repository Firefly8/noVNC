    ...
    _handleMouseMove(x, y) {
        ...
        if (this._mouseMoveTimer == null) {
            ...
            this._mouseMoveTimer = setTimeout(() => {
                // Note that the initial values of X and Y are passed here
                this._handleDelayedMouseMove(x, y);
            }, timeToWait);
        }
    }

    _handleDelayedMouseMove(initialX, initialY) {
        clearTimeout(this._mouseMoveTimer);
        this._mouseMoveTimer = null;

        if ((initialX === this._mousePos.x) &&
            (initialY === this._mousePos.y)) { return; }
